...
import { IdentificationIcon, ShareIcon, EmailIcon, MapPinIcon, GlobeAltIcon, UserIcon, EmployeeIdIcon } from '../icons/Icons';
    ...
    const handleShare = async (e: React.MouseEvent) => {
        ...
        const fallbackCopy = async () => {
            try {
                ...
                addToast('تم نسخ بيانات الموظف', 'لا تتوفر المشاركة المباشرة، تم النسخ إلى الحافظة.', 'info');
            } catch (err: any) {
                        ...
                        <div className="text-xs text-gray-500 mt-2 space-y-2 dark:text-gray-400">
                            ...
                            <div className="flex items-center gap-4 flex-wrap">
                                <div className="flex items-center gap-1.5 min-w-0">
                                    <EmployeeIdIcon className="w-3.5 h-3.5 flex-shrink-0"/>
