...
const TaskCard: React.FC<TaskCardProps> = ({ task, onToggleComplete, onEdit, onDelete }) => {
    ...
    return (
        <div className={`bg-white rounded-xl shadow-md p-4 grid grid-cols-[1fr_auto] items-start gap-4 transition-all duration-300 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 ${task.is_completed ? 'opacity-60' : ''}`}>
