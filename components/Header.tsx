...
const Header: React.FC<HeaderProps> = ({ onOpenSettings }) => {
    ...
    return (
        <header className="md:hidden bg-white/80 backdrop-blur-sm border-b border-gray-200 dark:bg-gray-900/80 dark:border-gray-700">
            <div className="container mx-auto px-3 py-2.5 md:px-4 flex justify-between items-center">
                <div>
