    ...
    return (
        <div className="bg-white rounded-xl shadow-md p-4 flex items-center gap-4 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
                 <button
                    onClick={onEdit}
                    className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 transition-all duration-200 transform hover:scale-110"
                    title="تعديل"
                >
